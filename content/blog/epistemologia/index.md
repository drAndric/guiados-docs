...
Los sesgos algorítmicos en la inteligencia artificial han sido tradicionalmente conceptualizados como problemas técnicos que requieren soluciones ingenieriles. Sin embargo, esta perspectiva predominante pasa por alto una dimensión más fundamental: **los sesgos algorítmicos constituyen ventanas únicas hacia la comprensión de la naturaleza misma del conocimiento humano y sus limitaciones epistémicas**. Lejos de ser meras fallas técnicas a corregir, estos sesgos revelan aspectos profundos sobre cómo construimos, validamos y transmitimos el conocimiento en la era digital.[^1][^2][^3]

La presente investigación propone un cambio paradigmático radical: **interpretar los sesgos en la IA no como obstáculos a superar, sino como oportunidades epistémicas privilegiadas para examinar críticamente nuestros procesos de conocimiento**. Esta reorientación conceptual encuentra su fundamento teórico en la tradición pragmatista estadounidense, particularmente en las contribuciones de Charles Sanders Peirce, William James y John Dewey, quienes desarrollaron una epistemología centrada en la práctica, la investigación colaborativa y la autocorrección sistemática.[^4][^5][^6][^7][^8][^9]

El **sesgo algorítmico**, definido como la desviación sistemática en los resultados de sistemas de IA que refleja prejuicios humanos incorporados en datos de entrenamiento o diseño algorítmico, se manifiesta en múltiples formas: sesgo de representación, sesgo de confirmación, sesgo cultural y temporal. Estas manifestaciones, lejos de ser aberraciones, constituyen **expresiones materializadas de las limitaciones inherentes a todo proceso de construcción de conocimiento humano**.[^2][^10][^3][^1]

## 2. Marco teórico: La epistemología pragmatista como lente analítico

### 2.1 Los fundamentos pragmatistas del conocimiento

La filosofía pragmatista ofrece un marco teórico particularmente adecuado para comprender los sesgos algorítmicos debido a su énfasis en **la naturaleza práctica, social y falible del conocimiento**. Charles Sanders Peirce estableció que "considerar qué efectos, que podrían tener consecuencias prácticas, concebimos que tiene el objeto de nuestra concepción. Entonces, nuestra concepción de estos efectos es toda nuestra concepción del objeto". Esta máxima pragmática resulta especialmente relevante para evaluar los sistemas de IA, donde las **consecuencias prácticas** de los algoritmos revelan las concepciones implícitas incorporadas en su diseño.[^7][^8]

William James extendió esta perspectiva al definir la **verdad como proceso de verificación**: "La verdad nos sucede a una idea. Se vuelve verdadera, es hecha verdadera por los eventos". En el contexto de la IA, los sesgos algorítmicos pueden entenderse como procesos de "verificación" fallidos que revelan las limitaciones de nuestras concepciones previas sobre neutralidad, objetividad y representatividad.[^11][^7]

John Dewey desarrolló una **teoría de la investigación** (*inquiry*) como proceso social y colaborativo dirigido hacia la resolución de problemas prácticos. Para Dewey, el conocimiento emerge del **intercambio social** y se valida mediante su capacidad para generar consecuencias deseables en contextos específicos. Esta perspectiva resulta crucial para comprender cómo los sesgos algorítmicos reflejan las dinámicas sociales y las estructuras de poder presentes en los procesos de construcción de conocimiento.[^12][^13][^8][^7]
...
**Sesgo cultural y temporal**: Evidencia la **naturalmente histórica y contextual** del conocimiento, mostrando cómo las condiciones sociales específicas se cristalizan en estructuras algorítmicas.[^19][^2]
...
Esta perspectiva sugiere que los **sesgos algorítmicos pueden funcionar como catalizadores** para el desarrollo de **marcos epistémicos más pluralistas** que reconozcan explícitamente la diversidad de formas válidas de conocimiento y experiencia.
...
**Primera contribución**: Los sesgos algorítmicos **materializan y hacen visible la carga teórica inherente** a todo proceso de conocimiento, proporcionando evidencia empírica concreta para tesis epistemológicas previamente abstractas.
